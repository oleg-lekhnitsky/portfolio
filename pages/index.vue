...
<template>
    <div class="wrapper desktop">
        ...
        <p style=" font-size: large; letter-spacing: .03em ;margin-bottom: 2em;">Snippets from my previous projects. These
            are designed to leave you in awe and make you want to explore more, rather than leaving the website right away.
        </p>
